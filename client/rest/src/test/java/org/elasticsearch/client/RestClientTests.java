...
public class RestClientTests extends RestClientTestCase {
    ...
    public void testCloseIsIdempotent() throws IOException {
        ...
        RestClient restClient = new RestClient(closeableHttpAsyncClient, 1_000, new Header[0], nodes, null, null, null, false, false);
        restClient.close();
    ...
    private static RestClient createRestClient() {
        ...
        return new RestClient(mock(CloseableHttpAsyncClient.class), randomLongBetween(1_000, 30_000),
                new Header[] {}, nodes, null, null, null, false, false);
    }
